...
function CharacterList({ characterSelected }: CharacterListProps) {
    ...
    return (
      ...
      >
        ...
        <div className={`${classes['life-info']} flex-1 ml-6 flex flex-col py-2`}>
          ...
          <div className={`${classes.desc} flex-1 break-all mt-1 overflow-hidden`}>
            {creatorNotes}
          </div>
  ...
  return (
    <div className={`${classes.characterList} h-full w-full`}>
