...
//   React.Dispatch<React.SetStateAction<Live2dExtensionManager | undefined>>
// >(function () {})
...
export function Live2dExtensionContextProvider({ children }: { children: ReactNode }) {
  // const [live2dExtensionManager, setLive2dExtensionManager] = useState<
  //   Live2dExtensionManager | undefined
  // >()
