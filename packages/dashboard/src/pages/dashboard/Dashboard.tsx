            ...
            <DropdownMenu aria-label="User Profile" className="w-[300px] h-[289px] rounded-xl">
              ...
              >
                <div className="flex flex-row justify-between items-center">
                  <div className="flex flex-row items-center">
                    <Avatar showFallback className="w-[40px] h-[40px]"></Avatar>
                    <span className="ml-[8px] text-[18px] font-[800]">Username</span>
                  </div>
              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-row justify-between items-center">
                    <div>
                      <div className="text-[#fff] text-[24px] font-[700]">12345</div>
